...
//     const [editarSenha, setEditarSenha] = useState<string>(''); // Este será o campo da senha para edição
...
//                     setEditarSenha(senha); // Popula o campo de senha com a senha recebida do backend
...
//         setLoading(true);
//         try {
//             const payload: AdvogadoData = { // O payload agora inclui a senha diretamente
//                 id: parseInt(advogadoId), // O ID pode precisar ser int dependendo do seu backend
//                 nome: editarNome,
//                 email: editarEmail,
//                 senha: editarSenha, // Envia a senha como ela está no campo
