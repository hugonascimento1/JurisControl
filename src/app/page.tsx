    ...
    <main className="flex min-h-screen flex-col justify-center items-center p-6">
      ...
      <section className="mt-12 - px-12 flex flex-col justify-center w-[92%]">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="p-4 bg-white rounded-lg border shadow hover:shadow-xl">
            ...
            <p className="text-sm text-gray-600">Centralize e acompanhe seus processos com facilidade.</p>
          </div>
          <div className="p-4 bg-white rounded-lg border shadow hover:shadow-xl">
            <ArrowRightIcon className="text-blue-600 mb-2" />
            <h3 className="font-semibold">Navegação rápida</h3>
            <p className="text-sm text-gray-600">Interface intuitiva pensada para advogados e clientes.</p>
          </div>
          <div className="p-4 bg-white rounded-lg border shadow hover:shadow-xl">
            <Lock className="text-blue-600 mb-2" />
            <h3 className="font-semibold">Acesso seguro</h3>
            <p className="text-sm text-gray-600">Seus dados protegidos com autenticação segura.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-12 - px-12 flex flex-col justify-center w-[92%]">
        ...
        <div className="w-full max-w-6xl mx-auto px-4 mt-10 flex flex-col md:flex-row items-center gap-10">
          ...
          {/* Texto da história */}
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-bold mb-4 text-[#030430]">Quem somos</h2>
            <p className="text-gray-700 text-base leading-relaxed">
              O <strong>JurisControl</strong> nasceu dentro da <strong>Universidade Católica de Pernambuco</strong>, inspirado pelas dores reais de um escritório parceiro — hoje nosso cliente.
              Nosso objetivo é <strong>tornar a gestão jurídica mais simples, eficiente e acessível</strong>, com tecnologia feita por quem conhece os desafios do setor.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-12 - px-12 flex flex-col justify-center items-center w-[92%] mb-12">
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="text-base text-gray-800 mt-2">
              <ul className="space-y-2 list-disc pl-5">
                <li>Automatização de tarefas e centralização de informações.</li>
                <li>Redução de erros com alertas e modelos prontos.</li>
                <li>Dashboards para decisões estratégicas com base em dados.</li>
                <li>Alta segurança no armazenamento de dados.</li>
                <li>Melhor atendimento e produtividade com ferramentas intuitivas.</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>
              <MessageCircleQuestion className="w-5 h-5 mr-2 text-blue-600" />
              O sistema tem agenda integrada?
            </AccordionTrigger>
            <AccordionContent className="text-base text-gray-800 mt-2">
              Sim! Você pode agendar audiências, reuniões e prazos com data, horário e descrição. Tudo fica organizado em uma agenda digital acessível de qualquer lugar.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent className="text-base text-gray-800 mt-2">
              Sim! O painel administrativo (dashboard) mostra indicadores como número de processos, compromissos e outras métricas importantes para a gestão.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger>
              <MessageCircleQuestion className="w-5 h-5 mr-2 text-blue-600" />
              O sistema gera documentos jurídicos automaticamente?
            </AccordionTrigger>
            <AccordionContent className="text-base text-gray-800 mt-2">
              Sim! Você pode usar modelos prontos ou gerar documentos com inteligência artificial a partir das informações inseridas no sistema.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
      ...
      <section className="w-full bg-[#030430] py-16 px-4 text-white">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <p className="text-gray-300">Tem dúvidas ou quer saber mais? Preencha o formulário abaixo e entraremos em contato.</p>
        </div>
        ...
        <Card className="max-w-3xl mx-auto bg-white shadow-lg">
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="message" placeholder="Como podemos te ajudar?" rows={5} />
            </div>
